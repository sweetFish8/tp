...
public class Message {
    ...
    static final String ADD_TRIP_MESSAGE = "The following trip has been added to your list! What would you like to do next?";
    static final String DELETE_TRIP_MESSAGE = "The following trip has been deleted from your list! What would you like to do next?";
    // exception
